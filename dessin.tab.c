...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DRAW = 3,                       /* DRAW  */
  YYSYMBOL_CIRCLE = 4,                     /* CIRCLE  */
  YYSYMBOL_RECTANGLE = 5,                  /* RECTANGLE  */
  YYSYMBOL_TRIANGLE = 6,                   /* TRIANGLE  */
  YYSYMBOL_OUVRIR_PAR = 7,                 /* OUVRIR_PAR  */
  YYSYMBOL_FERMER_PAR = 8,                 /* FERMER_PAR  */
  YYSYMBOL_VIRGULE = 9,                    /* VIRGULE  */
  YYSYMBOL_NOMBRE = 10,                    /* NOMBRE  */
  YYSYMBOL_COULEUR = 11,                   /* COULEUR  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DRAW", "CIRCLE",
  "RECTANGLE", "TRIANGLE", "OUVRIR_PAR", "FERMER_PAR", "VIRGULE", "NOMBRE",
  "COULEUR", "$accept", "programme", "instruction", YY_NULLPTR
};
...
{
       7,     1,     9,     1,    10,     4,     5,     6,    15,    11,
       0,     0,     0,    12,    13,    14,    16,    17,     0,     0,
      18,    19,    20,    21,    22,    23,     8
};
...
{
       0,     3,    13,    14,     4,     5,     6,     0,    14,     7,
       7,     7,    10,    10,    10,     9,     9,     9,    11,    11,
      11,     8,     8,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* instruction: DRAW CIRCLE OUVRIR_PAR NOMBRE VIRGULE COULEUR FERMER_PAR  */
#line 32 "dessin.y"
                                                             {
        genererCode("cercle", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
        printf("Commande de dessin d'un cercle de taille %d et couleur %d reconnue\n", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
    }
#line 1086 "dessin.tab.c"
    break;

  case 5: /* instruction: DRAW RECTANGLE OUVRIR_PAR NOMBRE VIRGULE COULEUR FERMER_PAR  */
#line 36 "dessin.y"
                                                                  {
        genererCode("rectangle", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
        printf("Commande de dessin d'un rectangle de taille %d et couleur %d reconnue\n", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
    }
#line 1095 "dessin.tab.c"
    break;

  case 6: /* instruction: DRAW TRIANGLE OUVRIR_PAR NOMBRE VIRGULE COULEUR FERMER_PAR  */
#line 40 "dessin.y"
                                                                 {
        genererCode("triangle", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
        printf("Commande de dessin d'un triangle de taille %d et couleur %d reconnue\n", (yyvsp[-3].nombre), (yyvsp[-1].couleur));
    }
#line 1104 "dessin.tab.c"
    break;


#line 1108 "dessin.tab.c"
